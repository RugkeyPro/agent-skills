...
TEMPLATE_ID = 'conceptual_coupling_framework'
CATEGORY = 'framework'
KIND = 'framework'
TITLE = 'Conceptual coupling framework diagram'
DESCRIPTION = 'process frameworks and coupling diagrams'
ORIGINAL_SCRIPT = 'figure-conceptual coupling framework diagram.py'
PREVIEW_BASENAME = 'nju_mp_darwin_coupling_framework'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
