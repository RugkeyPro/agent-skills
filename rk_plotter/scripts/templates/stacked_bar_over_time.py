...
TEMPLATE_ID = 'stacked_bar_over_time'
CATEGORY = 'bar_composition'
KIND = 'stacked_bar_time'
TITLE = 'Stacked bar chart over time'
DESCRIPTION = 'temporal component bars'
ORIGINAL_SCRIPT = 'figure-stacked_bar_chart_over_time.py'
PREVIEW_BASENAME = 'stacked_bar_sales_volume_by_year'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
