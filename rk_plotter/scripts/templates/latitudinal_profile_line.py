...
TEMPLATE_ID = 'latitudinal_profile_line'
CATEGORY = 'time_series'
KIND = 'latitudinal_profile'
TITLE = 'Latitudinal profile line plot'
DESCRIPTION = 'zonal means or meridional profiles'
ORIGINAL_SCRIPT = 'figure-latitudinal profile line plot.py'
PREVIEW_BASENAME = 'latitudinal_profile_ingestion_risk'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
