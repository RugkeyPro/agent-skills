...
TEMPLATE_ID = 'overlapping_kde'
CATEGORY = 'distributions'
KIND = 'overlap_kde'
TITLE = 'Overlapping KDE density plot'
DESCRIPTION = 'several one-dimensional densities'
ORIGINAL_SCRIPT = 'figure-overlapping KDE density plot.py'
PREVIEW_BASENAME = 'city_plastic_emissions_density_plot'
REQUIRES = ()
