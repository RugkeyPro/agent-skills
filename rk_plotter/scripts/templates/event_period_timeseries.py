...
KIND = 'event_period'
TITLE = 'Time-series line plot with event period'
DESCRIPTION = 'time series with highlighted event windows'
ORIGINAL_SCRIPT = 'figure-time series line plot with event-period.py'
PREVIEW_BASENAME = 'annual_mhw_days_enso_periods'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
