...
TEMPLATE_ID = 'hundred_percent_stacked_bar_compact'
CATEGORY = 'bar_composition'
KIND = 'stacked_percent'
TITLE = 'Compact 100 percent stacked bar chart'
DESCRIPTION = 'narrow composition panels'
ORIGINAL_SCRIPT = 'figure-100% stacked bar chart.py'
PREVIEW_BASENAME = 'rigid_flexible_emissions_stacked_bar'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
