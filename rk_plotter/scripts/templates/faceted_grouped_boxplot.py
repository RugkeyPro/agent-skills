...
TEMPLATE_ID = 'faceted_grouped_boxplot'
CATEGORY = 'distributions'
KIND = 'faceted_boxplot'
TITLE = 'Faceted grouped boxplot'
DESCRIPTION = 'grouped distributions split across facets'
ORIGINAL_SCRIPT = 'figure-faceted grouped boxplot.py'
PREVIEW_BASENAME = 'regional_country_boxplots'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
