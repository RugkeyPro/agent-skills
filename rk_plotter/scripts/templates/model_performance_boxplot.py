...
TEMPLATE_ID = 'model_performance_boxplot'
CATEGORY = 'distributions'
KIND = 'model_boxplot'
TITLE = 'Model performance comparison boxplot'
DESCRIPTION = 'model error or metric comparisons'
ORIGINAL_SCRIPT = 'figure-model performance comparison boxplot.py'
PREVIEW_BASENAME = 'model_mae_boxplot_yangtze_river_estuary'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
