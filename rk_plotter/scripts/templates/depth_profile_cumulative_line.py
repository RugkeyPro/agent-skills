...
TEMPLATE_ID = 'depth_profile_cumulative_line'
CATEGORY = 'time_series'
KIND = 'depth_profile'
TITLE = 'Depth-profile cumulative line plot'
DESCRIPTION = 'vertical profiles or sediment columns'
ORIGINAL_SCRIPT = 'figure-depth-profile cumulative line plot.py'
PREVIEW_BASENAME = 'cumulative_sediment_plastic_mass_depth_profile'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
