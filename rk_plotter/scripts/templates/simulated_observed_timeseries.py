...
TEMPLATE_ID = 'simulated_observed_timeseries'
CATEGORY = 'time_series'
KIND = 'observed_simulated'
TITLE = 'Simulated-observed time-series comparison'
DESCRIPTION = 'model output versus observations'
ORIGINAL_SCRIPT = 'figure-simulated–observed time series comparison plot.py'
PREVIEW_BASENAME = 'simulated_observed_time_series'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
