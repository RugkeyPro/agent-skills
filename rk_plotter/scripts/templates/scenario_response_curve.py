...
TEMPLATE_ID = 'scenario_response_curve'
CATEGORY = 'time_series'
KIND = 'response_curve'
TITLE = 'Scenario response curve plot'
DESCRIPTION = 'response curves or risk ratios'
ORIGINAL_SCRIPT = 'figure-scenario-based response curve plot.py'
PREVIEW_BASENAME = 'warming_probability_ratio_rcp_scenarios'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
