...
TEMPLATE_ID = 'stacked_percentage_bar'
CATEGORY = 'bar_composition'
KIND = 'stacked_percent'
TITLE = '100 percent stacked bar chart'
DESCRIPTION = 'composition shares across groups'
ORIGINAL_SCRIPT = 'figure-100%_stacked_bar_chart.py'
PREVIEW_BASENAME = 'stacked_percentage_bar_hfi_levels'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
