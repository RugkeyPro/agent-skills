...
CATEGORY = 'ml_explainability'
KIND = 'shap_bar'
TITLE = 'SHAP importance horizontal bar chart'
DESCRIPTION = 'ranked feature importance'
ORIGINAL_SCRIPT = 'figure-SHAP importance horizontal bar chart.py'
PREVIEW_BASENAME = 'shap_importance_barplot'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
