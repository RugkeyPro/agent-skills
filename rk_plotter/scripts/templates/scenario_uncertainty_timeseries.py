...
KIND = 'scenario_uncertainty'
TITLE = 'Scenario time series with uncertainty bands'
DESCRIPTION = 'scenario trajectories with uncertainty'
ORIGINAL_SCRIPT = 'figure-scenario-based time series plot with uncertainty bands.py'
PREVIEW_BASENAME = 'ssp_biomass_change_timeseries'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
