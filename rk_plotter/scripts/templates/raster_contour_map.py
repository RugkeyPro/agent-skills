...
CATEGORY = 'maps'
KIND = 'raster_contour'
TITLE = 'Raster map with contour lines'
DESCRIPTION = 'gridded fields with contour overlays'
ORIGINAL_SCRIPT = 'figure-raster map with contour lines.py'
PREVIEW_BASENAME = 'global_sst_99percentile_minus_mean'
REQUIRES = ()
