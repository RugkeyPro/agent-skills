...
TEMPLATE_ID = 'stacked_percentage_multiline_secondary_axis'
CATEGORY = 'bar_composition'
KIND = 'stacked_percent_line'
TITLE = 'Stacked percent bar plus multiline secondary axis'
DESCRIPTION = 'composition bars plus related lines'
ORIGINAL_SCRIPT = 'figure-stacked percentage bar + multi-line chart with secondary y-axis.py'
PREVIEW_BASENAME = 'plastic_type_contribution_and_ingestion_risk'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
