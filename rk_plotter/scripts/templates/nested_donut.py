...
TEMPLATE_ID = 'nested_donut'
CATEGORY = 'bar_composition'
KIND = 'nested_donut'
TITLE = 'Nested donut chart'
DESCRIPTION = 'hierarchical mass fate or budget composition'
ORIGINAL_SCRIPT = 'figure-nested donut chart.py'
PREVIEW_BASENAME = 'mass_fate_nested_donut_chart'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
