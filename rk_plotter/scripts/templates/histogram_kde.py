...
TEMPLATE_ID = 'histogram_kde'
CATEGORY = 'distributions'
KIND = 'hist_kde'
TITLE = 'Histogram with KDE curve'
DESCRIPTION = 'one-dimensional distribution with density'
ORIGINAL_SCRIPT = 'figure-histogram with KDE curve.py'
PREVIEW_BASENAME = 'prediction_uncertainty_histogram_kde'
REQUIRES = ()
