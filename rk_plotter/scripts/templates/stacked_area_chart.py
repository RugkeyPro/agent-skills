...
TEMPLATE_ID = 'stacked_area_chart'
CATEGORY = 'time_series'
KIND = 'stacked_area'
TITLE = 'Stacked area chart'
DESCRIPTION = 'cumulative flow or budget components'
ORIGINAL_SCRIPT = 'figure-stacked area chart.py'
PREVIEW_BASENAME = 'riverine_hg_export_stacked_area'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
