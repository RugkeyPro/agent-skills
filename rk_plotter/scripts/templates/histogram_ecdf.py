...
TEMPLATE_ID = 'histogram_ecdf'
CATEGORY = 'distributions'
KIND = 'hist_ecdf'
TITLE = 'Histogram plus empirical cumulative distribution'
DESCRIPTION = 'uncertainty distributions with cumulative probability'
ORIGINAL_SCRIPT = 'figure-histogram + empirical cumulative distribution plot.py'
PREVIEW_BASENAME = 'prediction_uncertainty_hist_cdf'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
