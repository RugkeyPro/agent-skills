...
TEMPLATE_ID = 'binary_proportion_bar'
CATEGORY = 'bar_composition'
KIND = 'binary_bar'
TITLE = 'Binary proportion bar chart'
DESCRIPTION = 'two-state proportions'
ORIGINAL_SCRIPT = 'figure-binary_proportion_bar_chart.py'
PREVIEW_BASENAME = 'protected_unprotected_barplot'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
