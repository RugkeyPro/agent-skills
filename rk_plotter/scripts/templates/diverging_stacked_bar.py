...
TEMPLATE_ID = 'diverging_stacked_bar'
CATEGORY = 'bar_composition'
KIND = 'diverging_bar'
TITLE = 'Diverging stacked bar chart'
DESCRIPTION = 'signed contributions around zero'
ORIGINAL_SCRIPT = 'figure-diverging stacked bar chart.py'
PREVIEW_BASENAME = 'buried_carbon_plastic_diverging_bar'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
