...
KIND = 'horizontal_stacked'
TITLE = 'Horizontal stacked bar chart'
DESCRIPTION = 'composition across ranked long labels'
ORIGINAL_SCRIPT = 'figure-horizontal stacked bar chart.py'
PREVIEW_BASENAME = 'transport_energy_vessels_stacked_bar'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
