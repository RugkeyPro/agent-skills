...
TEMPLATE_ID = 'choropleth_proportional_symbol_map'
CATEGORY = 'maps'
KIND = 'choropleth_symbol'
TITLE = 'Choropleth plus proportional symbol map'
DESCRIPTION = 'choropleths with magnitude overlays'
ORIGINAL_SCRIPT = 'figure-choropleth + proportional symbol map.py'
PREVIEW_BASENAME = 'global_mehg_export_yield_map'
REQUIRES = ()
