...
TEMPLATE_ID = 'horizontal_grouped_dual_axis_bar'
CATEGORY = 'bar_composition'
KIND = 'horizontal_dual_axis'
TITLE = 'Horizontal grouped bar with dual x-axes'
DESCRIPTION = 'paired metrics with paired units'
ORIGINAL_SCRIPT = 'figure-horizontal grouped bar chart with dual x-axes.py'
PREVIEW_BASENAME = 'dual_axis_horizontal_bar_hg_mehg'
REQUIRES = ()
OPTIONAL_REQUIRES = ()
